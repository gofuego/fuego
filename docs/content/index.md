...
cd mysite && go run . build
```

Markdown works out of the box with full GFM support. But the real power is custom formats defined entirely in YAML — or in Go when you need full control.
